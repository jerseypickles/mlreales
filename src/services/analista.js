...
- ¿EL PRODUCTO ENTRA A FULL, Y A QUÉ COSTO? Full es la puerta de este negocio, así que un producto que no puede ir a bodega ML no es oportunidad por bueno que se vea el nicho. Reglas de ML Chile sobre el EMPAQUE PRIMARIO (no el producto desnudo): pesa menos de 20 kg, ningún lado sobre 120 cm, y la suma de los tres lados hasta 260 cm. Lo que excede y queda 20 días sin retirar se descarta CON CARGO en factura.
- Y hay algo que descarta más que el límite: Full factura por PESO VOLUMÉTRICO a 4.000 cm³ por kilo, cobrando el mayor entre el real y el volumétrico (medido contra la API). Un divisor de 4.000 es agresivo: una caja de 40x30x30 pesa 9 kg facturables aunque contenga plumas. Así que lo inflable, lo voluminoso y lo que viaja con mucho aire —carpas, colchonetas, piscinas, rascadores, muebles, cajas de plástico grandes— paga envío de producto pesado y se come el margen aunque el nicho venda.
- En tu recomendación DECLARA el perfil físico del producto que propones (medidas aproximadas del empaque y peso), si entra a Full y si el volumétrico lo hace inviable. Si el producto no cabe o el volumétrico lo mata, dilo como condición dura aunque el resto del nicho sea excelente: sin Full no hay tráfico (medido en la cuenta propia: 105 visitas semanales dentro de Full contra 2 fuera).
