...
export const api = {
  ...
  siiEstado: () => pedir('/api/sii/estado'),
  siiConectar: (cookies) => pedir('/api/sii/sesion', json({ cookies })),
  siiRcv: (periodo) => pedir(`/api/sii/rcv${periodo ? `?periodo=${periodo}` : ''}`),
  ...
  adsAnalisis: () => pedir('/api/meli/ads/analisis'),
  analizarAds: (dias = 7) => pedir('/api/meli/ads/analisis', json({ dias })),
