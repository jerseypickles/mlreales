...
- BARRERAS DE IMPORTACIÓN: los eléctricos que se enchufan a la red (220V) requieren certificación SEC en Chile — costo y semanas extra, inviable para un primer pedido chico; alimentos y cosméticos requieren registro sanitario. Si el producto recomendado cae en eso, el veredicto debe reflejarlo (no_entrar o pivotear a un producto del nicho sin la barrera, ej: a pilas/USB/12V).
