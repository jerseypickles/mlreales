...
export function ventaEntreLecturas(antes, ahora) {
  ...
  // (/p/MLC…) Mercado Libre muestra al ganador de la caja de compra, y ese rota:
  // cuando a uno se le acaba el stock, la caja pasa a otro que tiene de sobra, y
  // sin esta guarda el cambio de vendedor se leía como "repuso". Medido el
